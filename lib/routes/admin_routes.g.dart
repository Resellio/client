        ...
        StatefulShellBranchData.$branch(
          routes: [
            GoRouteData.$route(
              ...
              factory: $AdminOrganizersRouteExtension._fromState,
            ),
          ],
        ),
        StatefulShellBranchData.$branch(
...
extension $AdminOrganizersRouteExtension on AdminOrganizersRoute {
  static AdminOrganizersRoute _fromState(GoRouterState state) =>
